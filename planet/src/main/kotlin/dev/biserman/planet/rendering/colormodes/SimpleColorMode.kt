...
class SimpleColorMode(planetRenderer: PlanetRenderer, override val name: String, override val categories: List<String>, val getFn: (PlanetTile) -> Color?) : PlanetColorMode(planetRenderer) {
