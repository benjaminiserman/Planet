...
fun Color.Companion.randomRgb(a: Int = 255, random: Random = Main.debugRandom) = Color.fromRgba(random.nextInt(256), random.nextInt(256), random.nextInt(256), a)

fun Color.Companion.randomHsv(s: Double = 1.0, v: Double = 1.0, a: Double = 1.0, random: Random = Main.debugRandom) = Color.fromHsv(random.nextDouble(), s, v, a)
