...
object Hersfeldt : ClimateClassifier {
    ...
    fun (ClimateClassification).altName() = this.copy(name = if (enableAlternativeNames) alternativeNames[this.name] ?: this.name else this.name)
    ...
    data class GddResults(val monthlyGdd: List<Double>, val monthlyGddl: List<Double>, val monthlyGddz: List<Double>, val monthlyGint: List<Double>, val totalGdd: Double, val totalGddl: Double, val totalGddz: Double, val totalGint: Double)
    ...
    fun estimateAet(datum: ClimateDatum, pet: List<Double>): List<Double> {
    ...
    fun aridityFactor(pet: List<Double>, aet: List<Double>) = aet.sum() / pet.sum()

    fun growthAridityFactor(pet: List<Double>, gdd: List<Double>, aet: List<Double>) = aet.zip(gdd).weightedAverage() / pet.zip(gdd).weightedAverage()

    fun growthSupply(datum: ClimateDatum, gdd: List<Double>, aet: List<Double>) = datum.months.map { it.precipitation }.zip(gdd).weightedAverage() / aet.average()

    fun evaporationRatio(datum: ClimateDatum, aet: List<Double>) = aet.sum() / datum.annualPrecipitation
    ...
    data class Diagnostics(val winterTemperature: Double, val summerTemperature: Double, val averageTemperature: Double, val annualPrecipitation: Double, val temperatureRange: Double, val precipitationRange: Double, val potentialEvapotranspiration: Double, val actualEvapotranspiration: Double, val aridityFactor: Double, val growthAridityFactor: Double, val growthSupply: Double, val evaporationRatio: Double, val totalGdd: Double, val totalGddz: Double, val totalGint: Double, val winterType: WinterType, val summerType: SummerType, val pet: List<Double>, val aet: List<Double>, val gddResults: GddResults)
